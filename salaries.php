...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
  <h1 class="w3-margin w3-jumbo">Salaries page</h1>
...
include_once("config.php");
        $query = "SELECT  E.employee_id, E.first_name, E.last_name, E.email_address, S.salary_amount  from Employees E left join Salaries S on 
        S.employee_id = E.employee_id where S.salary_amount is not null";
